            ...
            <table className="table table-bordered border-dark text-center">
                <thead>
                    <tr>
                        ...
                        <th className='pb-4' scope="col">Lộ trình training:
                            <br />
                            (Nhanh ; Chậm; Vừa sức)</th>
                        <th className='pb-5' scope="col"> Nêu Cảm nhận của bản thân sau một tuần training:
                            Tốt ; Không tốt</th>
                        <th className='pb-4' scope="col">Đánh giá mức độ tự tin, năng lực của mình sau một tuần:
                            <br />
                            (Tự tin ; Không tự tin)</th>
                        <th className='pt-2' scope="col">Đóng góng góp ý kiến cho lộ trình tuần sau tới.
                            <br />
